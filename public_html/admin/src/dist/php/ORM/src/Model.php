...
abstract class Model {
	...
	public static function getAllActives() {
		...
		$res = FwConnection::conn()->query("select * from `$table` as tbl left join tblActiveList as actives on tbl.$key = actives.item_id where actives.table_name = '$table' and actives.item_id > 0");
		$output = [];
