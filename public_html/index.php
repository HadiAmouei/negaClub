...
//         let exploded = href.split('.php?');
//          let form = '<form action="'+exploded[0]+'.php" method="post" fw-id="target-form-target-fw"></form>';
//         $("body").append(form);
//         let things = exploded[1].split('&');
//         things.forEach(function (val,index) {
//             let array = val.split('=');
//             $("form[fw-id=target-form-target-fw]").append('<input type="hidden" value="'+array[1]+'" name="'+array[0]+'">');
//         });
//     $("form[fw-id=target-form-target-fw]").submit()
//     }
// })
</script>
</body>
